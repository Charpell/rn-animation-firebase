...
const FIREBASEDB = `https://projectthree-c1ae9.firebaseio.comm`;
const APIKEY = `AIzaSyCpCqF1MTe6KLLQXlycpTtg7PjRSdiBnmI`;
...
export function getPosts() {
  const request = axios(`${FIREBASEDB}/posts.json?auth=${TOKEN}`).then(
    response => {
      let posts = [];
